...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/itachiXCoder'>ɪᴛᴀᴄʜɪ</a>
</b>"""
...
😈 ᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/itachiXCoder">ɪᴛᴀᴄʜɪ</a>
🧲 ᴊᴏɪɴ : <a href="https://t.me/Yagami_xlight">ʟɪɴᴋ</a>
</b>"""
...
ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ✨</b>'''
    ...
    REF_LINK = '''🔗 <b>Hᴇʀᴇ ɪs ᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ: <code>https://t.me/{}?start=itachi-{}</code>
...
"""
    ...
    FILE_CAPTION = """<a href='https://t.me/movie_mmsb'><b>ɴᴀᴍᴇ : {file_name}</b></a>"""

    RESTART_TXT = """<b>
📅 Dᴀᴛᴇ : <code>{}</code>
⏰ Tɪᴍᴇ : <code>{}</code>
🌐 Tɪᴍᴇᴢᴏɴᴇ : <code>Asia/Yangon</code></b>"""

    ALRT_TXT = """ʜᴇʏ ᴍɪɴɢᴀʟᴀᴘᴀʀ !"""
...
‼️ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄʜᴇᴄᴋ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs & ɪᴛ's ᴘʀɪᴄᴇs</b>"""
    ...
    BUY_PLAN = """<b>○ <u>ғɪʀsᴛ sᴛᴇᴘ</u> : ᴘᴀʏ ᴛʜᴇ ᴀᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇ ᴘʟᴀɴ ᴛᴏ ᴛʜɪs <code>09671630471</code> ᴡᴀᴠᴇ ᴍᴏɴᴇʏ ɴᴜᴍʙᴇʀ.
    
○ <u>secoɴᴅ sᴛᴇᴘ</u> : ᴛᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ᴀɴᴅ sʜᴀʀᴇ ɪᴛ ᴅɪʀᴇᴄᴛʟʏ ʜᴇʀᴇ: @itachiXCoder 
...
3000Ks ғᴏʀ ᴏɴᴇ ᴍᴏɴᴛʜ 👻
6000Ks ғᴏʀ ᴛᴡᴏ ᴍᴏɴᴛʜs 😚
30000Ks ғᴏʀ ᴏɴᴇ ʏᴇᴀʀ 😗
...
<code>/set_tutorial https://t.me/movie_mmsb/1</code>
